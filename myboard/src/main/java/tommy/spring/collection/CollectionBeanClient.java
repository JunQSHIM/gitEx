...
public class CollectionBeanClient {
	...
	public static void main(String[] args) {
		...
		/*
		 * Map<String,String> addressList = bean.getAddressList(); for(String
		 * key:addressList.keySet()) {
		 * System.out.println(String.format("키 : %s, 값 : %s",
		 * key,addressList.get(key))); }
		 */
		/*
		 * Properties addressList = bean.getAddressList(); for(String key:
		 * addressList.stringPropertyNames()) {
